...
#### Table of Contents
- [Blender 3.6 Update](#blender-36-update)
- [Preface](#preface)
- [Simple Inverted Hull in Blender](#simple-inverted-hull-in-blender)
  - [So how do we do this?](#so-how-do-we-do-this)
- [Geometry Node Based Inverted Hull](#geometry-node-based-inverted-hull)
  - [The basic principle](#the-basic-principle)
- [Implementation Time!](#implementation-time)
  - [1. Project Normals to Camera Plane](#1-project-normals-to-camera-plane)
  - [2. Scale Projected Normal Vectors in Screen Space](#2-scale-projected-normal-vectors-in-screen-space)
  - [3. Re-Project Back to Original Normal Vectors](#3-re-project-back-to-original-normal-vectors)
  - [4. Final Steps](#4-final-steps)
  - [Done!](#done)
- [Download](#download)

## Blender 3.6 Update
In the [old version] of this post, you'd need to re-setup the drivers to retrieve scene data whenever you want to use it in a new file simply due to Blender's limitations with it comes to linked libraries and drivers. 
...
<center>
<img src="/blogs/geonode_outline/images/guilty_gear_example.jpg" alt="Guilty Gear Example">
</center>
<center>
<h5><i> Look closely on the outlines, and you can see how it follows the polygons. This is especially evident on Sol's left deltoids. </i></h5></center>

## **Simple Inverted Hull in Blender** 
...
<center>
<img src="/blogs/geonode_outline/images/simple_invert_hull_example.png" width="400"> <img src="/blogs/geonode_outline/images/simple_invert_hull_modifier_example.png" width="250">
</center>
...
![Extreme Angle Example](/blogs/geonode_outline/images/simple_extreme_example.png)
...
## **Geometry Node Based Inverted Hull** 
...
![Fixed Extreme Angle Example](/blogs/geonode_outline/images/advanced_extreme_example_.png)
<center><h5><i> Now the entire model's outline is much more uniform, with the buttons looking much better too </i></h5></center>
<center>
<img src="/blogs/geonode_outline/gifs/outline_demo_gif.gif" width="800">
<h5><i> Realtime Demo </i></h5>
</center>
![Geonode Overview](/blogs/geonode_outline/gifs/geonode_demo_gif.gif)
...
![Process Demo](/blogs/geonode_outline/gifs/process_demo.gif)
...
![Process Demo from Cam](/blogs/geonode_outline/gifs/process_demo_from_cam.gif)
...
![Active Camera Data Node Setup](/blogs/geonode_outline/images/1_active_camera_data_node.png)
...
![Normal Projection Geo Nodes](/blogs/geonode_outline/images/1_normal_proj_overview_3.6.png)
...
![Calculate World Space Distance Per Pixel](/blogs/geonode_outline/images/2a_pixel_dist_geo_node_3.6.png)
...
<center>
<img src="/blogs/geonode_outline/images/focal_length_driver_3.6.png" height="300"> <img src="/blogs/geonode_outline/images/resolution_driver_3.6.png" height="300"><img src="/blogs/geonode_outline/images/driver_connection.png" height="300"></center>
...
![Attenuation and G Vector](/blogs/geonode_outline/images/2c_attenuation_3.6.png)

### 3. Re-Project Back to Original Normal Vectors 
...
![Re-projection](/blogs/geonode_outline/images/3_reprojection_3.6.png)
...
![Re-projection_2](/blogs/geonode_outline/images/3_vector_projection_group.png)
...
![Culling](/blogs/geonode_outline/images/4_culling_3.6.png)
...
![World Space Outline Option](/blogs/geonode_outline/images/4_world_space_outline_3.6.png)
...
![Weight and inversion Check](/blogs/geonode_outline/images/4_weight_inversion_check_3.6.png)
...
![Done!](/blogs/geonode_outline/images/4_finish.png)
...
![Overview](/blogs/geonode_outline/images/4_finish_overview.png)
