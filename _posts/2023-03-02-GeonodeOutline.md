...
![GG Xrd Example](/assets/images/guilty_gear_example.jpg)
...
<center>
<img src="/assets/images/simple_invert_hull_example.png" width="400"> <img src="/assets/images/simple_invert_hull_modifier_example.png" width="250">
</center>
...
![Extreme Angle Example](/assets/images/simple_extreme_example.png)
...
![Normal Projection Geo Nodes](/assets/images/1_normal_proj_overview.png)
...
![Calculate World Space Distance Per Pixel](/assets/images/2a_pixel_dist_geo_node.png)
...
<center>
<img src="/assets/images/focal_length_driver.png" width="200"> <img src="/assets/images/resolution_driver.png" width="240"></center>

**2c.** Attenuate and multiply with step 1

![Attenuation and G Vector](/assets/images/2c_attenuation.png)

### 3. Re-project back to Normal Vector
**3a.**
![Re-projection](/assets/images/3_reprojection.png)
...
![Re-projection_2](/assets/images/3_vector_projection_group.png)
...
![Culling](/assets/images/4_culling.png)
<center><h5><i> Mix node's input A is the g Vector, and B is the s Vector from 3 </i></h5></center>
...
![World Space Outline Option](/assets/images/4_world_space_outline.png)
...
![Weight and inversion Check](/assets/images/4_weight_inversion_check.png)
...
![Done!](/assets/images/4_finish.png)
